...
{
    "name": "Repair Service - Estimation",
    "version": "1.0",
    "category": "Project",
    "author": "Synconics Technologies Pvt. Ltd.",
    "summary": "Allows to create, view sales quotation and online confirmation quotations",
    "website": "www.synconics.com",
    "description": """
Repair Service - Estimation
===========================
* This application allows to create, view sales quotation and online confirmation quotations.
...
""",
    "depends": ["sale_management", "sync_helpdesk"],
    "data": [
