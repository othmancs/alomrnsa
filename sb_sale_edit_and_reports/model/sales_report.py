        ...
        for obj in partners:
            ...
            for branch in existing_branches:
                ...
                for line in current_branch_lines:
                    ...
                    worksheet.write(row, col + 9, total_out_refund_price, format5)  # اجمالي الارجاعات
                    worksheet.write(row, col + 10, total_out_refund_purchase_price, format5)  # اجمالي تكلفة الارجاعات
