...
{
    'name': 'Repair Service - Ticket Automation',
    'version': '1.0',
    'category': 'Project',
    'author': 'Synconics Technologies Pvt. Ltd.',
    'summary': 'Allows to create ticket automation action',
    'website': 'www.synconics.com',
    'description': """
Repair Service - Ticket Automation
============================
* This application allows to automatically trigger actions for ticket.
...
""",
    'depends': ['base_automation', 'sync_helpdesk'],
    'data': [
        'views/base_automation_view.xml',
        'views/menu.xml'
    ],
    'demo': ['demo/helpdesk_automation_demo.xml'],
