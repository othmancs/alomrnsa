...
{
    'name': 'Repair Service - Ticket From Lead',
    'version': '1.0',
    'category': 'Project',
    'author': 'Synconics Technologies Pvt. Ltd.',
    'summary': 'Allows to create new ticket from lead',
    'website': 'www.synconics.com',
    'description': """
Repair Service - Ticket From Lead
=================================
* This application allows to create new ticket from lead.
...
""",
    'depends': ['crm', 'sync_helpdesk'],
    'data': [
        'data/ticket_data.xml',
        'views/crm_lead_views.xml'
    ],
    'demo': ['demo/helpdesk_lead_ticket_demo.xml'],
