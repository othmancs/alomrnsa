...
{
    'name': 'Repair Service - Appointments',
    'version': '1.0',
    'category': 'Project',
    'author': 'Synconics Technologies Pvt. Ltd.',
    'summary': 'Allows to create appointment from ticket',
    'website': 'www.synconics.com',
    'description': """
Repair Service - Appointments
=============================
* This application allows to create customer appoinment through ticket.
...
""",
    'depends': ['sync_helpdesk', 'calendar'],
    'data': [
    ...
    'demo': [
        'demo/helpdesk_appointment_demo.xml'
    ],
    'images': [
