...
class SaleOrderWizard(models.TransientModel):
    ...
    partner_id = fields.Many2one('res.partner', string='العميل', domain="[('type', '!=', 'private'), ('company_id', 'in', (False, company_id))]")
    ...
    def pdf_report_action(self):
        ...
        # Apply filters for the new fields
        created_by_ids = self.created_by_id
        if created_by_ids:
            domain += [('created_by_id', 'in', created_by_ids.ids)]
