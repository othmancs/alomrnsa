...
{
    'name': 'Repair Service - Single Use Inventory Items',
    'version': '1.0',
    'category': 'Sale',
    'author': 'Synconics Technologies Pvt. Ltd.',
    'summary': 'Allows to decide one time use product in sales order',
    'website': 'www.synconics.com',
    'description': """
Repair Service - Single Use Inventory Items
===========================================
* This application allows to decide one time use product in sales order.
* If product quantity is reach to 0 then product is not shown in sales order line when new sales order will create.
