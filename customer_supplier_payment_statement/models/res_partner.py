...
class Partner(models.Model):
    ...
    def _compute_customer_report_ids(self):
                """Include customer invoices and credit notes."""
    ...
    def _compute_vendor_statement_ids(self):
        """Include vendor bills and credit notes."""
    ...
    def main_query(self):
        """Include invoices and credit notes in query."""
    ...
    def amount_query(self):
        """Include invoices and credit notes in total calculation."""
