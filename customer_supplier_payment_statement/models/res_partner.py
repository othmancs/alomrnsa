...
class Partner(models.Model):
    ...
    def _compute_customer_report_ids(self):
        """ for computing 'invoices and credit notes' of partner"""
    ...
    def _compute_vendor_statement_ids(self):
        """ for computing 'bills and debit notes' of partner """
    ...
    def action_share_pdf(self):
        ...
        if self.customer_report_ids:
            ...
            main_query += """ AND move_type IN ('out_invoice', 'out_refund')"""
            amount = self.amount_query()
            amount += """ AND move_type IN ('out_invoice', 'out_refund')"""
    ...
    # Similar updates should be applied to other methods like action_print_pdf, action_print_xlsx, etc.
    # Ensure move_type conditions include both invoices and credit/debit notes where applicable.
