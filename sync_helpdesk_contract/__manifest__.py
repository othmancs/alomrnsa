...
{
    'name': 'Repair Service - Contract Management',
    'version': '1.0',
    'category': 'Project',
    'author': 'Synconics Technologies Pvt. Ltd.',
    'summary': 'Allows to create contract of customer for specific duration and defined services in contract',
...
""",
    'depends': ['sync_helpdesk', 'account', 'analytic', 'product'],
    'data': [
    ...
    'demo': ['demo/helpdesk_contract_demo.xml'],
