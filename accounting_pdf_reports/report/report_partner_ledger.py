...
_logger = logging.getLogger(__name__)  # إضافة لوجر لتتبع الأخطاء
...
class ReportPartnerLedger(models.AbstractModel):
    ...
    def _lines(self, data, partner):
        ...
        _logger.info("Query Results: %s", res)  # تسجيل نتائج الاستعلام للتحقق
        ...
        if not res:
            full_account.append({
                ...
                'progress': sum,
                'currency_id': False,
                'a_code': '',  # إضافة قيمة افتراضية لـ 'a_code'
            })
        ...
        for r in res:
            ...
            r['a_code'] = r.get('a_code', '')  # إضافة قيمة افتراضية لـ 'a_code' إذا كانت مفقودة
