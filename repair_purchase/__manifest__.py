...
{
    "name": "Repair Service - Spare Parts Purchase",
    "version": "1.0",
    "category": "Project",
    "author": "Synconics Technologies Pvt. Ltd.",
    "summary": "Allows to automatically create repair parts purchase order base of procurement rules",
    "website": "www.synconics.com",
    "description": """
Repair Service - Spare Parts Purchase
=====================================
* This application allows to automatically create repair parts purchase order base of procurement rules.
...
""",
    "depends": ["repair", "stock", "purchase"],
    "data": ["security/security.xml", "views/repair_views.xml"],
    "demo": [],
