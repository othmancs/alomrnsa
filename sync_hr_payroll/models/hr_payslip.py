...
class HrPayslip(models.Model):
    ...
    def _get_employee_contracts(self):
        return self.contract_id.ids or self.get_contract(self.employee_id, self.date_from, self.date_to)
    ...
    def compute_sheet(self):
        for payslip in self:
            ...
            contract_ids = payslip._get_employee_contracts()
