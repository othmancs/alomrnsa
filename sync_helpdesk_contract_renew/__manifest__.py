...
{
    'name': 'Repair Service - Contract Renewal',
    'version': '1.0',
    'category': 'Project',
    'author': 'Synconics Technologies Pvt. Ltd.',
    'summary': 'Allows to renew contract for the specific time duration',
    'website': 'www.synconics.com',
    'description': """
Repair Service - Contract Renewal
=================================
* This application allows to renew contract for the specific time duration.
...
""",
    'depends': ['sync_helpdesk_contract'],
    'data': [
         'views/contract_view.xml',
    ],
    'demo': [
        'demo/helpdesk_contract_renew_demo.xml',
    ],
