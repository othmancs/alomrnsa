...

{
    ...
    """,
    'author': 'BROWSEINFO',
    'website': 'https://www.browseinfo.com/demo-request?app=bi_product_kit&version=16&edition=Community',
    "price": 39,
    "currency": 'EUR',
    ...
    'installable': True,
    'auto_install': False,
    'live_test_url':'https://www.browseinfo.com/demo-request?app=bi_product_kit&version=16&edition=Community ',
