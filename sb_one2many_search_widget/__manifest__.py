...
#############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            '/sb_one2many_search_widget/static/src/css/header.css',
            '/sb_one2many_search_widget/static/src/js/one2manySearch.js',
            '/sb_one2many_search_widget/static/src/xml/one2manysearch.xml',
        ],
    },
    "installable": True,
    "application": False,
