...
from odoo.addons.sync_hr_payroll.models.hr_payslip import HrPayslip

# HrPayslip.get_worked_day_lines = get_worked_day_lines
# setattr(HrPayslip, 'get_worked_day_lines', get_worked_day_lines)
...
def get_worked_day_lines(self, contracts, date_from, date_to):
    ...
    for contract in contracts.filtered(lambda contract: contract.resource_calendar_id):
        ...
        for holiday_status_id, lines in groupby(leave_detail_object, lambda l: l.leave_id.holiday_status_id.id):
            ...
            if leave_detail_obj.filtered(lambda l: l.unpaid_leave):
                current_leave_struct = leaves.setdefault(holiday_status_id, {
                            ...
                            'sequence': 5,
                            'code': holiday_status_id.name or '',
        ...
        leave_days = contract.employee_id._get_leave_days_data_batch(day_from, day_to, calendar=contract.resource_calendar_id)
        ...
        attendances = {
            ...
            'sequence': 1,
            'code': 'WORK100',
            'number_of_days': float((work_data['days']) + leave_days[self.employee_id.id]['days']) - sum(total_leave_day_list),
